    ...
    var isOperator = /[x/+‑]/,
        ...
        Calculator = function (_React$Component) {
            ...
            function Calculator(e) {
                var t;
                return _classCallCheck(this, Calculator), (t = _super.call(this, e)).state = {
                    currentVal: "0",
                    prevVal: "0",
                    formula: "",
                    currentSign: "pos",
                    lastClicked: ""
                }, t.maxDigitWarning = t.maxDigitWarning.bind(_assertThisInitialized(t)), t.handleOperators = t.handleOperators.bind(_assertThisInitialized(t)), t.handleEvaluate = t.handleEvaluate.bind(_assertThisInitialized(t)), t.initialize = t.initialize.bind(_assertThisInitialized(t)), t.handleDecimal = t.handleDecimal.bind(_assertThisInitialized(t)), t.handleNumbers = t.handleNumbers.bind(_assertThisInitialized(t)), t
            }
            return _createClass(Calculator, [{
                ...
                value: function handleEvaluate() {
                    if (!this.state.currentVal.includes("Limit")) {
                        for (var expression = this.state.formula; endsWithOperator.test(expression);) expression = expression.slice(0, -1);
